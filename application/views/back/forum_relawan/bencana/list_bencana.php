      ...
      <div class="row">
        <div class="col-xs-12">
          ...
          <div class="box">
            ...
            <a class="btn btn-info" href="<?php echo site_url('forum/bencana/tambah_bencana') ?>" ><i class="glyphicon glyphicon-plus"></i> Tambah Bencana</a>
            </div>
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                  ...
                  <tr>
                      ...
                      <td>
                      <center>
                        <a href="<?php echo base_url() ?>forum/bencana/detail_bencana?id_bencana=<?php echo $data->id_bencana; ?>" class="btn btn-sm btn-success"> <span class="glyphicon glyphicon-search" aria-hidden="true"></span></a>
