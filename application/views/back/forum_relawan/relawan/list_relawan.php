...
foreach ($data_relawan as $data) {?>
                                            <tr>
                                                ...
                                                <td>
                                                    <?php
if ($data->status_pengajuan_relawan == 1) {?>
                                                    <span class="pull-right badge bg-blue">DISETUJI</span>
                                                    <?php } elseif ($data->status_pengajuan_relawan == 2) {?>
                                                    <span class="pull-right badge bg-red">DITOLAK</span>
                                                    <?php }?>
                                                </td>
                                                <td>
                                                    <center>
                                                        <a href="<?php echo base_url() ?>forum/relawan/detail_relawan?id_relawan=<?php echo $data->id_relawan; ?>"
                                                            class="btn btn-sm btn-success"> <span
                                                                class="glyphicon glyphicon-search"
                                                                aria-hidden="true"></span></a>

                                                        <a href="<?php echo site_url() ?>forum/relawan/hapus_relawan/
														<?php echo $data->id_relawan; ?>" class="btn btn-sm btn-danger tombol-hapus">
