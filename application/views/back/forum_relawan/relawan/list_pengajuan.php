...
foreach ($data_pengajuan as $data) {?>
                                            <tr>
                                                ...
                                                <td>
                                                    <center>
                                                        <a href="<?php echo base_url() ?>forum/relawan/detail_pengajuan_relawan?id_relawan=<?php echo $data->id_relawan; ?>"
                                                            class="btn btn-sm btn-success"> <span
                                                                class="glyphicon glyphicon-search"
                                                                aria-hidden="true"></span></a>
                                                        <a href="<?php echo site_url() ?>forum/relawan/hapus_pengajuan_relawan/<?php echo $data->id_relawan; ?>"
