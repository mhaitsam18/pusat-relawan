...
foreach ($data_pengajuan as $data) {?>
                                            <tr>
                                                ...
                                                <td><?=$data->alasan_bergabung?>
                                                <td>
                                                    <center>
                                                        <a href="<?php echo base_url() ?>forum/pelatihan/detail_pengajuan_pelatihan?id_relawan=<?php echo $data->id_relawan; ?>"
                                                            class="btn btn-sm btn-success"> <span
                                                                class="glyphicon glyphicon-search"
                                                                aria-hidden="true"></span></a>
                                                        <a href="<?php echo site_url() ?>forum/pelatihan/hapus_pengajuan_relawan/<?php echo $data->id_relawan; ?>/<?=$data->id_pelatihan;?>"
