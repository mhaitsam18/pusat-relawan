                        ...
                        <div class="col-xs-12">
                            <div class="box">
                                <div class="box-header">
                                    <tbody>
                                        <h3>Detail Pengajuan Pelatihan <span
                                                class="badge badge-secondary"><?=$data_relawan[0]->nama_lengkap?></span>
                                        </h3>
                                    </tbody>
                                </div>
                                <table class="table table-striped">
                                    ...
                                    <tr>
                                        ...
                                        <td>: <a href="<?=base_url('assets/berkas_relawan/' . $data_relawan[0]->surat_keterangan_sehat);?>"
                                    ...
                                    <tr>
                                        ...
                                        <td>: <a href="<?=base_url('assets/berkas_relawan/' . $data_relawan[0]->skck);?>"
                                                class="btn btn-sm btn-primary "> <span class=""
                                                    aria-hidden="true"></span> DOWNLOAD</a></td>
                                        <td></td>
                                        <td></td>
                                    ...
                                    <tr>
                                        ...
                                        <td>: <a href="<?=base_url('assets/berkas_relawan/' . $data_relawan[0]->surat_persetujuan_wali);?>"
                                                class="btn btn-sm btn-primary "> <span class=""
                                                    aria-hidden="true"></span> DOWNLOAD</a></td>
                                        <td></td>
                                        <td></td>
