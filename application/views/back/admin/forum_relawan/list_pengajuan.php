...
foreach ($data_pengajuan as $data) {?>
                                            <tr>
                                                ...
                                                <td>
                                                    <center>
                                                        <a href="<?php echo base_url() ?>admin/forum_relawan/detail_pengajuan?id_forum=<?php echo $data->id_forum; ?>"
                                                            class="btn btn-sm btn-success"> <span
                                                                class="glyphicon glyphicon-search"
                                                                aria-hidden="true"></span></a>
                                                        <a href="<?php echo site_url() ?>admin/forum_relawan/hapus_pengajuan?id_akun=<?php echo $data->id_akun; ?>"
