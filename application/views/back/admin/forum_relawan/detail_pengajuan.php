                        ...
                        <div class="col-xs-12">
                            <div class="box">
                                <div class="box-header">
                                    <tbody>
                                        <h3>Detail Pengajuan Forum <span
                                                class="badge badge-secondary"><?=$pengajuan_forum[0]->nama_forum?></span>
                                        </h3>
                                    </tbody>
                                </div>
                                <table class="table table-striped">
                                    <tr>
                                        ...
                                        <td><img src="<?=base_url('assets/images/logo_forum/' . $pengajuan_forum[0]->logo);?>"
                                    ...
                                    <tr>
                                        <td colspan="5">
                                            <center>
                                                <a href="<?php echo base_url() ?>admin/forum_relawan/acc_pengajuan?id_forum=<?php echo $pengajuan_forum[0]->id_forum; ?>"
