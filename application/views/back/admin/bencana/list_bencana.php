                ...
                <section class="content">
                  ...
                  foreach ($data_bencana as $data) { ?>
                                            <tr>
                                                ...
                                                <td><img src="<?= base_url('assets/images/gambar_bencana/'.$data->gambar);  ?>"
                                                        alt="" width="70"></td>
                                                <td>
                                                    <center>
                                                        <a href="<?php echo base_url() ?>admin/bencana/detail_pengajuan_bencana?id_bencana=<?php echo $data->id_bencana; ?>"
                                                            class="btn btn-sm btn-success"> <span
                                                                class="glyphicon glyphicon-search"
                                                                aria-hidden="true"></span></a>
                                                        <a href="<?php echo site_url() ?>admin/bencana/hapus_pengajuan_bencana?id_bencana=<?php echo $data->id_bencana; ?>"
